 ...
 * Validates that complexity metrics meet defined thresholds
 */
...
function main() {
  console.log('🔍 Running Complexity Threshold Check...\n');
  ...
  // Print results
  console.log('📊 Complexity Threshold Results:');
  console.log('==============================');
  ...
  if (!results.mutation.passed) {
    console.log(`   Current: ${results.mutationScore}%`);
