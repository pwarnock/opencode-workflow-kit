...
```javascript
import { SyncEngine, createDefaultConfiguration } from '@pwarnock/cody-beads-integration';
...
```javascript
import { SyncEngine } from '@pwarnock/cody-beads-integration';
...
cody-beads-sync:
  ...
  script:
    ...
    - echo "$CODY_BEADS_CONFIG" > cody-beads.config.json
    - cody-beads config validate
...
```javascript
import { SyncEngine, WorkflowEngine } from '@pwarnock/cody-beads-integration';
