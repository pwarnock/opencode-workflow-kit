...
def cody_version_add(
    version_number: str, version_name: str, features: str
) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "message": f"Error creating version: {str(e)}"}
...
def cody_version_build(version: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "message": f"Error building version: {str(e)}"}


def create_subagent(
    name: str, agent_type: str, tools: list, description: str = ""
) -> Dict[str, Any]:
...
def cody_refresh() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"success": False, "message": f"Error refreshing project: {str(e)}"}
