...
cat > package.json << 'EOF'
{
  ...
  "dependencies": {
    "@pwarnock/toolkit-core": "workspace:*",
    "commander": "^12.1.0",
    "chalk": "^5.3.0",
    "inquirer": "^10.0.2",
    "ora": "^8.0.1",
...
import { SyncEngine } from '@pwarnock/toolkit-core';
import { ConfigManager } from '../config/ConfigManager.js';
import { Logger } from '../utils/Logger.js';

export class LiaisonPlugin implements CLIPlugin {
  name = 'liaison';
  version = '0.5.0';
...
```typescript
// packages/liaison/src/sync/SyncEngine.ts
import {
  UnifiedConfig,
  SyncOptions,
  SyncResult,
...
```typescript
// packages/liaison/src/sync/ConflictResolver.ts
import {
  SyncConflict,
...
describe('Unified Workflow Integration', () => {
  ...
  describe('Sync Workflows', () => {
    it('should perform bidirectional sync', async () => {
      ...
      const config = await configManager.loadConfig();
      const { SyncEngine } = await import('../packages/liaison/src/sync/SyncEngine.js');
